...
const translations = {
  es: {
    ...
    platformUserManual: 'Manual de Usuario de la Plataforma',
    loginRequired: 'Inicio de Sesión Requerido',
    goToDashboard: 'Ir al Panel',
    goToLoginPage: 'Ir a la Página de Inicio de Sesión',
    dashboard: 'Panel',
    enterSystem: 'Ingresar al Sistema',
    copyrightBiakam: '© 2025 BIAKAM - Plataforma ConnectEG para la República de Guinea Ecuatorial',
    footerDescription: 'Direccionamiento Digital Unificado y Gestión de Emergencias • Conectando Ciudadanos, Servicios y Seguridad',
    
    // About section
    ourMission: 'Nuestra Misión',
    ourVision: 'Nuestra Visión',
    keyPartners: 'Socios Clave',
    ministryOfInterior: 'Ministerio del Interior',
    governmentOversightPolicy: 'Supervisión gubernamental y política',
    localGovernments: 'Gobiernos Locales',
    provincialImplementation: 'Implementación provincial',
    technologyPartners: 'Socios Tecnológicos',
    platformDevelopmentMaintenance: 'Desarrollo y mantenimiento de la plataforma',
    missionDescription: 'Crear un sistema nacional de direcciones integral, preciso y accesible que sirva como base para mejorar los servicios públicos, el desarrollo económico y la calidad de vida de todos los ciudadanos de Guinea Ecuatorial.',
    visionDescription: 'Ser la infraestructura de direcciones digitales líder en África Central, permitiendo la entrega eficiente de servicios, apoyando el crecimiento empresarial y conectando cada ubicación en Guinea Ecuatorial a la economía digital.',
    
    // Help section
    findAnswersQuestions: 'Encuentra respuestas a preguntas comunes y obtén ayuda para usar la plataforma.',
    frequentlyAskedQuestions: 'Preguntas Frecuentes',
    howRegisterNewAddress: '¿Cómo registro una nueva dirección?',
    howRegisterAnswer: 'Inicia sesión en tu cuenta, navega a "Agregar Dirección", completa la información requerida incluyendo coordenadas y envía para verificación.',
    howLongVerification: '¿Cuánto tiempo toma la verificación?',
    verificationTimeAnswer: 'La verificación de direcciones típicamente toma 3-5 días hábiles, dependiendo de la ubicación y complejidad del envío.',
    canUpdateExistingAddress: '¿Puedo actualizar una dirección existente?',
    updateAddressAnswer: 'Sí, puedes solicitar actualizaciones a direcciones existentes. Los cambios deben ser verificados por personal autorizado antes de ser aprobados.',
    contactSupport: 'Contactar Soporte',
    emailSupport: 'Soporte por Email',
    phoneSupport: 'Soporte Telefónico',
    officeHours: 'Horario de Oficina',
    mondayFridayHours: 'Lunes - Viernes: 8:00 AM - 5:00 PM',
    saturdayHours: 'Sábado: 9:00 AM - 1:00 PM',
    
    // Manual section
    comprehensiveGuideUsing: 'Guía integral para usar los sistemas de Registro de Direcciones y Gestión de Emergencias.',
    gettingStarted: 'Comenzando',
    accountRegistration: '1. Registro de Cuenta',
    createAccountEmailPassword: 'Crea una cuenta usando tu dirección de email y una contraseña segura. Verifica tu email para activar tu cuenta.',
    profileSetup: '2. Configuración de Perfil',
    completeProfilePersonalInfo: 'Completa tu perfil con información personal precisa. Esto nos ayuda a verificar tu identidad para envíos de direcciones.',
    addressRegistrationProcess: 'Proceso de Registro de Direcciones',
    stepLocationInformation: 'Paso 1: Información de Ubicación',
    selectCorrectProvinceCity: 'Selecciona la provincia y ciudad correcta, luego proporciona detalles de calle y edificio.',
    stepCoordinates: 'Paso 2: Coordenadas',
    useCurrentLocationButton: 'Usa el botón "Obtener Ubicación Actual" o ingresa manualmente las coordenadas GPS. Las coordenadas precisas son esenciales para la verificación.',
    stepDocumentation: 'Paso 3: Documentación',
    uploadClearPhoto: 'Sube una foto clara de la ubicación y proporciona cualquier descripción adicional que ayude a identificar la dirección.',
    stepVerification: 'Paso 4: Verificación',
    submitRequestReview: 'Envía tu solicitud para revisión. Los agentes de campo verificarán la ubicación y los registradores aprobarán el código de dirección final.',
    addressRegistryUserRoles: 'Roles de Usuario del Registro de Direcciones',
    citizens: 'Ciudadanos',
    citizensDescription: 'Pueden buscar direcciones, enviar nuevas solicitudes de direcciones y ver sus envíos.',
    fieldAgents: 'Agentes de Campo',
    fieldAgentsDescription: 'Verifican ubicaciones de direcciones en sitio y aprueban o rechazan envíos basándose en visitas de campo.',
    verifiers: 'Verificadores',
    verifiersDescription: 'Revisan reportes de agentes de campo y realizan verificación adicional si es necesario.',
    registrars: 'Registradores',
    registrarsDescription: 'Generan códigos UAC oficiales y publican direcciones verificadas al registro nacional.',
