...
const translations = {
  es: {
    ...
    closed: 'Cerrado',
    // Unit Management
    manageEmergencyUnitsAndAssignments: 'Gestionar unidades de emergencia y asignaciones de oficiales',
    createPoliceUnit: 'Crear Unidad Policial',
    unitName: 'Nombre de la Unidad',
    unitCode: 'Código de la Unidad',
    policeUnitType: 'Tipo de Unidad Policial',
    patrolUnit: 'Unidad de Patrulla',
    rapidResponseTeam: 'Equipo de Respuesta Rápida',
    trafficEnforcement: 'Control de Tráfico',
    investigationUnit: 'Unidad de Investigación',
    specialOperations: 'Operaciones Especiales',
    radioFrequency: 'Frecuencia de Radio',
    vehicleId: 'ID del Vehículo',
    assignOfficer: 'Asignar Oficial',
    assignedOfficers: 'Oficiales Asignados',
    availableOfficers: 'Oficiales Disponibles',
    seniorOfficer: 'Oficial Senior',
    corporal: 'Cabo',
    sergeant: 'Sargento',
    lieutenant: 'Teniente',
    ...
    removeFromUnit: 'Remover de la Unidad',
    ...
    emergencyResponseSettings: 'Configuración de Respuesta de Emergencia',
    configureEmergencyResponseParameters: 'Configurar parámetros de respuesta de emergencia',
    targetResponseTime: 'Tiempo de Respuesta Objetivo (minutos)',
    numberOfPriorityLevels: 'Número de Niveles de Prioridad',
    backupRequestThreshold: 'Umbral de Solicitud de Respaldo (minutos)',
    enableAutoDispatch: 'Habilitar Auto-Despacho',
    saveEmergencySettings: 'Guardar Configuración de Emergencia',
    notificationSettings: 'Configuración de Notificaciones',
    configureNotificationChannelsBehavior: 'Configurar canales de notificación y comportamiento',
    emailNotifications: 'Notificaciones por Email',
    smsNotifications: 'Notificaciones SMS',
    pushNotifications: 'Notificaciones Push',
    notificationRetryCount: 'Número de Reintentos de Notificación',
    testNotifications: 'Probar Notificaciones',
    saveNotificationSettings: 'Guardar Configuración de Notificaciones',
    securitySettings: 'Configuración de Seguridad',
    configureSecurityPoliciesAuth: 'Configurar políticas de seguridad y autenticación',
    ...
    enableDataEncryption: 'Habilitar Cifrado de Datos',
    ...
    target510minutes: 'Objetivo: 5-10 minutos',
    activeUnits: 'Unidades Activas',
    resolutionRate: 'Tasa de Resolución',
    incidentTimeline: 'Cronología de Incidentes',
    dailyIncidentReportsResolutions: 'Reportes diarios de incidentes y resoluciones',
    incidentsByType: 'Incidentes por Tipo',
    incidentsByPriority: 'Incidentes por Prioridad',
    unitPerformance: 'Rendimiento de Unidades',
    unitEfficiency: 'Eficiencia de Unidad',
    incidentsHandled: 'Incidentes Manejados',
  ...
  en: {
    ...
    closed: 'Closed',
    // Unit Management
    manageEmergencyUnitsAndAssignments: 'Manage emergency units and officer assignments',
    createPoliceUnit: 'Create Police Unit',
    unitName: 'Unit Name',
    unitCode: 'Unit Code',
    policeUnitType: 'Police Unit Type',
    patrolUnit: 'Patrol Unit',
    rapidResponseTeam: 'Rapid Response Team',
    trafficEnforcement: 'Traffic Enforcement',
    ...
    emergencyResponseSettings: 'Emergency Response Settings',
    configureEmergencyResponseParameters: 'Configure emergency response parameters',
    targetResponseTime: 'Target Response Time (minutes)',
    numberOfPriorityLevels: 'Number of Priority Levels',
    backupRequestThreshold: 'Backup Request Threshold (minutes)',
    enableAutoDispatch: 'Enable Auto-Dispatch',
    saveEmergencySettings: 'Save Emergency Settings',
    notificationSettings: 'Notification Settings',
    configureNotificationChannelsBehavior: 'Configure notification channels and behavior',
    ...
    configureSecurityPoliciesAuth: 'Configure security policies and authentication',
    ...
    // Analytics
    policeAnalytics: 'Police Analytics',
    last7days: 'Last 7 days',
    last30days: 'Last 30 days',
    last90days: 'Last 90 days',
    totalIncidents: 'Total Incidents',
    avgResponseTime: 'Avg Response Time',
    target510minutes: 'Target: 5-10 minutes',
    activeUnits: 'Active Units',
    resolutionRate: 'Resolution Rate',
    incidentTimeline: 'Incident Timeline',
    dailyIncidentReportsResolutions: 'Daily incident reports and resolutions',
    incidentsByType: 'Incidents by Type',
    incidentsByPriority: 'Incidents by Priority',
  ...
  fr: {
    ...
    closed: 'Fermé',
    // Unit Management
    manageEmergencyUnitsAndAssignments: 'Gérer les unités d\'urgence et les affectations d\'officiers',
    createPoliceUnit: 'Créer une Unité de Police',
    unitName: 'Nom de l\'Unité',
    unitCode: 'Code de l\'Unité',
    policeUnitType: 'Type d\'Unité Policière',
    patrolUnit: 'Unité de Patrouille',
    rapidResponseTeam: 'Équipe d\'Intervention Rapide',
    trafficEnforcement: 'Contrôle Routier',
    investigationUnit: 'Unité d\'Enquête',
    specialOperations: 'Opérations Spéciales',
    radioFrequency: 'Fréquence Radio',
    vehicleId: 'ID du Véhicule',
    assignOfficer: 'Assigner un Officier',
    assignedOfficers: 'Officiers Assignés',
    availableOfficers: 'Officiers Disponibles',
    unitLead: 'Chef d\'Unité',
    seniorOfficer: 'Officier Supérieur',
    corporal: 'Caporal',
    sergeant: 'Sergent',
    lieutenant: 'Lieutenant',
    ...
    removeFromUnit: 'Retirer de l\'Unité',
    // System Configuration
    backup: 'Sauvegarde',
    restore: 'Restaurer',
    generalSettings: 'Paramètres Généraux',
    basicSystemConfiguration: 'Configuration système de base',
    systemName: 'Nom du Système',
    defaultLanguage: 'Langue par Défaut',
    timezone: 'Fuseau Horaire',
    defaultRegion: 'Région par Défaut',
    systemDescription: 'Description du Système',
    saveGeneralSettings: 'Sauvegarder les Paramètres Généraux',
    emergencyResponseSettings: 'Paramètres de Réponse d\'Urgence',
    configureEmergencyResponseParameters: 'Configurer les paramètres de réponse d\'urgence',
    targetResponseTime: 'Temps de Réponse Cible (minutes)',
    numberOfPriorityLevels: 'Nombre de Niveaux de Priorité',
    backupRequestThreshold: 'Seuil de Demande de Renfort (minutes)',
    enableAutoDispatch: 'Activer l\'Auto-Dispatch',
    saveEmergencySettings: 'Sauvegarder les Paramètres d\'Urgence',
    notificationSettings: 'Paramètres de Notification',
    configureNotificationChannelsBehavior: 'Configurer les canaux de notification et le comportement',
    emailNotifications: 'Notifications Email',
    smsNotifications: 'Notifications SMS',
    pushNotifications: 'Notifications Push',
    notificationRetryCount: 'Nombre de Tentatives de Notification',
    testNotifications: 'Tester les Notifications',
    saveNotificationSettings: 'Sauvegarder les Paramètres de Notification',
    securitySettings: 'Paramètres de Sécurité',
    configureSecurityPoliciesAuth: 'Configurer les politiques de sécurité et l\'authentification',
    ...
    enableDataEncryption: 'Activer le Chiffrement des Données',
    saveSecuritySettings: 'Sauvegarder les Paramètres de Sécurité',
    // Analytics
    policeAnalytics: 'Analyses Policières',
    last7days: '7 derniers jours',
    last30days: '30 derniers jours',
    last90days: '90 derniers jours',
    totalIncidents: 'Incidents Totaux',
    avgResponseTime: 'Temps de Réponse Moyen',
    target510minutes: 'Cible: 5-10 minutes',
    activeUnits: 'Unités Actives',
    resolutionRate: 'Taux de Résolution',
    incidentTimeline: 'Chronologie des Incidents',
    dailyIncidentReportsResolutions: 'Rapports quotidiens d\'incidents et résolutions',
    incidentsByType: 'Incidents par Type',
    incidentsByPriority: 'Incidents par Priorité',
    unitPerformance: 'Performance des Unités',
    unitEfficiency: 'Efficacité de l\'Unité',
