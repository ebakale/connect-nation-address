...
export const BusinessAddressRegistrationForm = () => {
      ...
      <Card className="p-6">
        ...
        <Tabs value={currentTab} onValueChange={setCurrentTab}>
          ...
          <TabsContent value="accessibility" className="space-y-4 mt-6">
            ...
            <div className="border-t pt-4">
              <h3 className="font-medium mb-4">{t('common:visibility')}</h3>
        ...
        <div className="flex justify-between mt-6">
          ...
          <Button onClick={handleSubmit} disabled={loading}>
            {loading ? t('common:loading') : t('business:registration.registerBusiness')}
          </Button>
        </div>
      </Card>
    </div>
