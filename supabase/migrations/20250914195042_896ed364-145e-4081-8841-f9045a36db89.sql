-- Update search function to allow exact UAC matches for private addresses
-- while still protecting them from general text searches
...
AS $function$
  SELECT 
    ...
    a.street,
    a.building,
    -- For private addresses found by exact UAC, show approximate coordinates
    CASE 
