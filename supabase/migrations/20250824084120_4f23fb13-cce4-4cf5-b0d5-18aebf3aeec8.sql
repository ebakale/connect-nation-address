...
-- Now create operator sessions using actual incident IDs
...
-- Active sessions using incident UUIDs
('00000000-0000-0000-0000-000000000001', now() - interval '3 hours', 'active', 
 ARRAY[(SELECT id FROM emergency_incidents WHERE incident_number = 'INC-2024-000003'), 
       (SELECT id FROM emergency_incidents WHERE incident_number = 'INC-2024-000008')]),
('00000000-0000-0000-0000-000000000002', now() - interval '2 hours', 'active', 
 ARRAY[(SELECT id FROM emergency_incidents WHERE incident_number = 'INC-2024-000001'), 
       (SELECT id FROM emergency_incidents WHERE incident_number = 'INC-2024-000005')]),
('00000000-0000-0000-0000-000000000003', now() - interval '1 hour', 'active', 
 ARRAY[(SELECT id FROM emergency_incidents WHERE incident_number = 'INC-2024-000009')]),
('00000000-0000-0000-0000-000000000004', now() - interval '4 hours', 'active', 
 ARRAY[(SELECT id FROM emergency_incidents WHERE incident_number = 'INC-2024-000010')]);
