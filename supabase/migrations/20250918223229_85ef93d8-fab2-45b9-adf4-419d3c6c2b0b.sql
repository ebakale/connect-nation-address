...
DROP FUNCTION IF EXISTS public.initiate_residency_verification(uuid,uuid,text,text,legal_document_type,text,text);

-- Create the new function that works with citizen addresses
