-- Create CAR integration tables and functions
-- Now that the enum values exist, we can use them safely
...
-- Add trigger to car_permissions table for timestamp updates
