-- Fix approve_business_address_request to use correct enum case
...
BEGIN
  ...
  -- Create organization record with correct enum case (OTHER not other)
  INSERT INTO public.organization_addresses (
    ...
    COALESCE(UPPER(org_metadata->>'business_category'), 'OTHER')::business_category, -- Fix: use UPPER() and correct default
