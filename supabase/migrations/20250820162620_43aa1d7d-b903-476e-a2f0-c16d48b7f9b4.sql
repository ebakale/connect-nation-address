...
-- Create a view for the review queue that includes both new requests and flagged addresses
...
SELECT 
  'flagged_address' as source_type,
  a.id,
  a.user_id,
  a.latitude,
  a.longitude,
  ...
  a.photo_url,
  'flagged' as status,
  'Flagged for re-review: ' || a.flag_reason as justification,
  a.flagged,
  a.flag_reason,
  a.flagged_by,
  a.flagged_at,
...
-- Add RLS policy for the review queue view
CREATE POLICY "Staff can view review queue" 
