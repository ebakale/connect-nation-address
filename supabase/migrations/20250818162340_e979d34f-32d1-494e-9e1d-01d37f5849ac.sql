...
BEGIN
  ...
  -- Generate check digit (simple algorithm for demo)
...
-- Update all addresses to use the new unified UAC format
UPDATE public.addresses 
SET uac = public.generate_unified_uac(
  country, 
  region, 
  city, 
  ROW_NUMBER() OVER (
...
-- Add constraint to ensure UAC uniqueness
