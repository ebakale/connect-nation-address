-- Update the app_role enum to include all the new roles
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'citizen';
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'property_claimant';
...
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'ndaa_admin';
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'partner';
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'auditor';
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'data_steward';
